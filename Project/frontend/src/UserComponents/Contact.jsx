          ...
          <form onSubmit={handleSubmit} className='contactform'>
            ...
            <label className='contactlabel'>
              ...
              <input width="900px"
                ...
                className={!isValidEmail ? 'invalid' : 'contactemail'}
              />
            ...
            <br/>
              Message:<br></br>
              <textarea name="message" value={formData.message} onChange={handleChange} className='contactmsg'/>
            </label>
